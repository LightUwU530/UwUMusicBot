...
const { YOUTUBE_API_KEY } = require("../util/UwUMBotUtil");
...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!message.member.voice.channel)
      return message.reply("<:LUMeyes:810807117979582468>〡You need to join a voice channel first!").catch(console.error);
